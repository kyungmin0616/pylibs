...
if not set(Libs).issubset(set(sys.modules.keys())):
   ...
   from schism_file import (read_schism_hgrid, read_schism_bpfile,getglob,
        ...
        read_schism_grid,schism_transect,combine_schism_gr3,interp_schism_2d,interp_schism_hotstart,
        checkrun)
   ...
   from src.mylib import sort_all as asort
   ...
   from src.schism_file import get_schism_output_info as schout_info
   from src.schism_file import get_schism_var_info as schvar_info
